...
void LegionCore::Module::SetEnableModulesList(std::string_view modulesList) { _modulesList = std::string{modulesList}; }

std::vector<std::string_view> LegionCore::Module::GetEnableModulesList()
{
